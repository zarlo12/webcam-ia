...
You are photographing THIS SPECIFIC PERSON wearing a circus costume and professional makeup/styling - like a professional portrait photographer would. The costume, lighting, and environment change - THE FACE DOES NOT. Shot with cinema camera (RED Komodo 6K), 50mm portrait lens, f/2.8 shallow depth of field.`;
    ...
    if (mode === "terror") {
      switch (style) {
        case "payaso-maldito":
          return `${baseInstructions}\n\nCIRCUS CHARACTER: EVIL CLOWN (Pennywise meets American Horror Story aesthetic). Photograph THIS PERSON dressed as a spine-chilling sinister clown performer.\n\nCOSTUME & STYLING: Distressed Victorian-era clown costume - weathered burgundy and midnight black silks, torn tulle ruffles, antique brass buttons, oxidized silver chains. Realistic fabric wear with frayed edges and authentic aging. MAKEUP APPLICATION (preserve their natural face shape): Professional horror theatrical makeup applied OVER their existing features - theatrical white base with intentional cracks, burgundy/purple contouring following THEIR natural bone structure, exaggerated painted smile extending from THEIR natural lip line, dark crimson painted nose accent, smudged dark shadow around THEIR eyes. HAIR STYLING: Style THEIR EXISTING HAIR into disheveled clown aesthetic - if they have dark hair keep it dark, if light keep it light, just add styling product for wild/dampened matted texture. Optional: small hair color accents or temporary spray on tips only (NOT full color change).\n\nACTION & PROPS: Holding vintage circus props in menacing way - rusted knife-throwing knives, cracked porcelain doll with missing eye, weathered playing cards floating mid-air around them, broken jack-in-the-box with creepy puppet emerging. EXPRESSION: Capture THEIR natural expression with unsettling charisma - slight head tilt, piercing gaze toward camera, subtle sinister smile showing hint of teeth. ENVIRONMENT: Abandoned 1920s circus tent during thunderstorm - tattered red velvet curtains blowing in wind, shattered vintage wooden props scattered, antique broken carousel horses with peeling paint, vintage circus posters torn and bleeding, dusty amber light shafts cutting through darkness, volumetric fog on weathered floor, ravens perched on old tent poles, cobwebs catching light. Background: Silhouettes of abandoned circus apparatus, broken mirrors reflecting fragmented light, old seats with ghostly shadows. LIGHTING: Single antique spotlight with warm tungsten creating dramatic shadows, purple and deep red gel side lights (film noir atmosphere), lightning flash from tent opening creating backlight, practical oil lamp creating warm glow on props. Dust particles and fog catching colored light beams. CINEMATOGRAPHY: f/2.0 shallow DoF keeping THEIR FACE razor sharp, slight low-angle adding menace, subtle vignette darkening edges. Color palette: Desaturated reds (#8B0000), purples (#4B0082), sickly greens (#2F4F2F), rust oranges. Tim Burton meets Del Toro meets IT (2017) aesthetic.${commonEnding}`;
        
        case "dueno-circo-oscuro":
          return `${baseInstructions}\n\nCIRCUS CHARACTER: DARK RINGMASTER (Victorian Gothic Opera aesthetic). Photograph THIS PERSON dressed as an elegant yet menacing circus master.\n\nCOSTUME & STYLING: Museum-quality Victorian ringmaster tailcoat - midnight black wool with deep crimson velvet lapels, intricate gold embroidery, matching waistcoat with antique brass buttons, crisp white high-collar shirt, black silk cravat with decorative skull pin. Tall top hat with burgundy band and raven feather. White leather gloves. ACCESSORIES: Ornate ebony cane with silver skull handle topped with glowing crystal, vintage leather bullwhip coiled elegantly, antique pocket watch with haunting melody. GROOMING: Style THEIR HAIR immaculately (slicked back or elegantly styled keeping THEIR natural color), groom any existing facial hair precisely. Subtle dark eye makeup enhancing THEIR natural eye shape for intensity.\n\nACTION & SPECTACLE: Captured mid-command gesture - whip extended with supernatural blue flame trailing from tip, or cane raised commanding shadowy figures. Ravens circling overhead with spread wings, enchanted circus props levitating around them (floating top hats, dancing canes, spinning rings of fire). EXPRESSION: Capture THEIR commanding presence - raised chin, penetrating gaze from THEIR eyes, hint of knowing smile on THEIR lips, aura of dark charisma. Authoritative stance with hand extended holding cane/whip, other hand gesturing with theatrical showmanship. ENVIRONMENT: Gothic circus main stage at witching hour - grand proscenium arch with carved gargoyle details, heavy crimson velvet curtains billowing dramatically, antique gas lamps flickering with green/blue flames, theatrical haze on polished wooden stage creating mystery. Background spectacle: Ghostly silhouettes of performers in shadows, phantom audience in Victorian formal wear (soft focus), vintage circus wagons with ornate carvings, hanging aerial silks swaying mysteriously, grand chandelier with dripping candles, gothic arched windows showing full moon, trained ravens perched on baroque frames. LIGHTING: Dramatic theatrical noir - powerful key from above creating sharp shadows on THEIR FACE (following bone structure), crimson gel backlights creating glowing rim around figure, purple/blue accent floor lights creating upward shadows and mystery, warm practical gas lamp creating amber pools, moonlight shafts through windows. Volumetric fog catching colored light beams, dust particles dancing in light. CINEMATOGRAPHY: Slightly low angle emphasizing authority and power, f/2.2 shallow DoF, rich crushed blacks with glowing highlights. Bleach bypass color grade with pushed reds/golds, desaturated shadows. Crimson Peak meets Phantom of the Opera meets Sleepy Hollow aesthetic.${commonEnding}`;
        
        case "domador-salvaje":
          return `${baseInstructions}\n\nCIRCUS CHARACTER: WILD BEAST TAMER (Mad Max meets 1930s Circus Danger Acts). Photograph THIS PERSON dressed as a battle-hardened fearless animal tamer in peak danger moment.\n\nCOSTUME & STYLING: Distressed genuine leather ensemble - worn brown leather vest with visible claw scratches/repairs, weathered cotton shirt with rolled sleeves, thick leather belt with brass buckle, dark fitted pants in tall leather boots with metal buckles. Protective leather arm guards with metal studs and brass rivets showing wear and battle damage. Heavy leather gloves. ACCESSORIES: Braided leather whip extended mid-crack with motion blur on tip, heavy brass/steel chains draped over shoulder, leather bandolier, brass whistle on chain. APPEARANCE: Keep THEIR natural facial features and skin tone. Style THEIR HAIR to look wind-swept and rugged (using THEIR natural hair color/texture). Subtle dirt/dust makeup effects on skin for realism - but maintaining THEIR skin tone and texture. Authentic sweat glistening on forehead.\n\nACTION & WILD SPECTACLE: CRITICAL - Photograph them in commanding stance facing THREE BENGAL TIGERS in dramatic poses around them: One massive tiger on raised platform mid-roar showing fangs (mouth open, visible teeth, powerful expression), second tiger prowling low on opposite side with glowing eyes locked on camera, third tiger standing on hind legs with front paws raised showing claws. Person captured mid-whip crack establishing dominance - whip extended toward tigers, fearless commanding posture, zero fear visible. WILD BEASTS ARE ESSENTIAL - tigers must be clearly visible, detailed, photorealistic, showing their power while respecting the tamer. EXPRESSION: Capture THEIR fierce, fearless demeanor - intense eye contact from THEIR eyes toward camera, determined warrior expression on THEIR face, jaw set, powerful confident stance showing they own the arena. Captured mid-motion - dynamic power pose. ENVIRONMENT: Gritty 1930s circus beast arena at night - massive reinforced iron cage with thick bars catching rim light, heavy chains from ceiling, scattered straw on worn wooden floor, deep claw marks gouged into wooden posts and floor, dramatic shadows, smoke/dust in air from movement. Vintage circus apparatus - metal chairs, pedestals, wooden platforms at different heights where tigers pose. Weathered circus ring floor with tiger paw prints in dust. Background: Torch sconces on cage bars, vintage circus posters warning of danger, distant audience silhouettes watching behind safety barriers. LIGHTING: Gritty high-contrast film noir - harsh side key creating dramatic shadows following THEIR cheekbone structure, minimal fill for dangerous mood, powerful orange/amber rim light separating them from darkness, tiger eyes reflecting light with eerie glow, smoke/dust catching amber light. Multiple practical torches/lanterns creating fire-lit atmosphere, spotlight from above creating god rays through haze. Color palette: Desaturated browns, deep oranges, charcoal blacks, splashes of deep red, amber firelight, tiger orange and black stripes catching light. CINEMATOGRAPHY: Eye-level dynamic angle capturing power, f/2.0 shallow DoF keeping THEIR FACE razor-sharp with tigers slightly softer in background/sides, slight motion blur on whip mid-crack, heavy gritty film grain. The Revenant meets Peaky Blinders meets Life of Pi circus aesthetic. Maximum danger, maximum courage, epic confrontation frozen in time.${commonEnding}`;
        
        case "acrobata-extremo":
          return `${baseInstructions}\n\nCIRCUS CHARACTER: EXTREME AERIAL ACROBAT (Cirque du Soleil Dark Edition meets Blade Runner). Photograph THIS PERSON as a gravity-defying performer in death-defying aerial stunt.\n\nCOSTUME & STYLING: Form-fitting performance suit in technical fabrics - midnight black athletic material with burgundy and electric blue geometric patterns, strategic mesh panels, industrial silver zippers and hardware, leather straps crisscrossing torso and thighs, metallic studs along seams. Gothic athletic aesthetic. Wrapped hands/wrists with black athletic tape, bare feet or minimal aerial shoes. THEIR natural athletic physique emphasized by costume fit and dramatic lighting. HAIR STYLING: Style THEIR HAIR secured back for aerial performance (keeping THEIR natural color) - pulled back smoothly or flowing dramatically with movement.\n\nEXTREME ACTION & HEIGHT: Suspended 40+ feet in air performing DEATH-DEFYING STUNT - captured mid-aerial trick in one of these dramatic poses: 1) Horizontal split while holding aerial silk with one hand, other arm extended toward camera in beautiful arc, or 2) Inverted hang from trapeze bar by knees, arms spread wide, or 3) Spectacular back arch suspended only by ankle wraps with arms flowing. THEIR hair and silk fabrics flowing with motion showing speed and danger. Slight motion blur on moving elements (silks, hair) while THEIR FACE stays razor-sharp. Electric sparks or ember trails following their path through air (pyrotechnic effects). Other aerial apparatuses visible at different heights - multiple performers mid-flight in background creating spectacle. EXPRESSION: Capture THEIR intense focus mixed with performance adrenaline - THEIR eyes locked fiercely on camera showing zero fear, face showing concentration and thrill of extreme height, slight adventurous smile, warrior focus. ENVIRONMENT: High above massive dark circus arena showing EXTREME VERTICAL DROP - camera angle emphasizing terrifying height, arena floor FAR below (40+ feet) with tiny silhouettes of awestruck audience visible, distant ring floor, safety net barely visible below. Aerial equipment creating web of danger - multiple trapeze bars, crossing aerial silks in deep red/black/electric blue, suspended hoops, rope ladders, all at different heights creating depth. Industrial circus ceiling with exposed steel beams, professional rigging, catwalks with crew silhouettes, hanging chain mechanisms. Lightning or electrical effects in background. LIGHTING: Extreme theatrical aerial lighting - powerful spotlights from below creating dramatic upward illumination and long shadows, cyan and magenta backlights creating electric glow on fabric and body edges, volumetric light beams cutting through darkness revealing suspended chalk powder and mist, rim lighting outlining every muscle and fabric fold. Practical pyrotechnic trails, strobe effects freezing motion, neon accent lights on rigging. Color-changing LED strips on silks. CINEMATOGRAPHY: Dynamic perspective with extreme vertigo sense - looking up from below showing terrifying height, shallow DoF with background arena dissolving into bokeh, f/2.2 aperture creating beautiful colored orbs from distant lights. Color grade: Cyberpunk-circus meets Tron - deep blues (#000080), electric cyans (#00FFFF), vibrant magentas (#FF00FF), neon purples, rich blacks. Blade Runner 2049 meets Cirque du Soleil KÀ aesthetic. Edge of seat danger, superhuman performance, breathtaking spectacle.${commonEnding}`;
        
        case "pesadilla-circo":
          return `${baseInstructions}\n\nCIRCUS CHARACTER: NIGHTMARE CIRCUS ENTITY (Pan's Labyrinth meets Silent Hill meets Crimson Peak). Photograph THIS PERSON as an otherworldly, hauntingly beautiful circus being from dark fairytale realm.\n\nCOSTUME & STYLING: Surreal fusion of vintage circus and dark fantasy - aged burgundy and black performance costume with unexpected supernatural elements: Victorian lace layered with distressed leather, antique skeleton keys on tarnished silver chains, small cracked mirrors reflecting fragmented light, aged circus canvas strips, preserved dried flowers (deep red roses, black dahlias, purple orchids) woven throughout costume and hair creating garden of death aesthetic. Elegant yet deeply unsettling aesthetic mixing beauty and decay. MAKEUP & EFFECTS (preserve THEIR face): Professional fantasy theatrical makeup applied OVER THEIR FEATURES creating otherworldly glamour - very pale foundation (porcelain or ash tone) maintaining THEIR bone structure perfectly, burgundy/purple contouring following THEIR natural facial contours creating shadow, metallic gold or silver accents on THEIR cheekbones/temples catching light like supernatural glow, dark lips (deep burgundy or black) enhancing THEIR natural lip shape, dramatic dark smokey effect around THEIR eyes with optional unusual contact lenses in gold/silver/violet (keeping THEIR eye shape exact). Optional: Small subtle fantasy prosthetic accents (tiny crystal horns, delicate pointed ear tips, small decorative face gems) blended seamlessly - but keeping THEIR FACE completely recognizable. HAIR: Style THEIR EXISTING HAIR with fantasy circus aesthetic (maintaining THEIR natural color, adding dramatic styling elements - braids woven with flowers, ribbons, small bones, decorative hairpins, slight backcomb for volume).\n\nSURREAL SPECTACLE & PROPS: CRITICAL FANTASY ELEMENTS creating dreamlike horror - Ornate cracked Venetian/masquerade mask (half-face revealing THEIR features), vintage circus props transformed into dark artifacts (rusted juggling clubs floating mid-air defying gravity, antique music box with ballerina spinning, aged playing cards suspended around them showing face cards with haunting eyes, pocket watch frozen at midnight). Dark fantasy familiars: Black raven with spread wings perched on their shoulder or hand looking at camera, or elegant black cat with glowing eyes at their feet, or dark butterflies (black/deep purple) landing on extended hand and floating around. Supernatural elements visible: Wisps of colored smoke (purple/teal) curling around fingers suggesting magic, small floating orbs of light, flower petals suspended mid-fall defying gravity. ACCESSORIES: Hauntingly beautiful objects - ornate hand mirror showing mysterious reflection, transformed vintage circus apparatus, aged leather-bound book, crystal ball with swirling mist, candelabra with dripping wax. EXPRESSION: Capture THEIR enigmatic otherworldly presence - slight mysterious head tilt showing elegant neck, THEIR direct unsettling gaze locked on camera with knowing ancient wisdom in eyes, expression perfectly balanced between serene beauty and subtle menace, hint of knowing smile suggesting dangerous secrets. Regal yet eerie composure. ENVIRONMENT: Surreal nightmare circus realm creating impossible dreamscape - distorted perspective with converging lines and Escher-inspired impossible geometry, vintage circus elements in beautiful decay (ornate gilt mirrors with cracks creating web patterns, faded circus posters showing ghostly performers from past, broken carousel horses with peeling paint and missing glass eyes revealing wooden bones, aged circus apparatus overgrown with dark roses). Thick volumetric fog rolling across floor, multiple practical candles and antique lanterns creating pools of warm light in cold darkness. Blurred surreal floating elements creating magical realism: Circus props (hoops, ribbons, flowers) suspended mid-air, fabric strips flowing upward defying gravity, playing cards creating spiral, clock gears floating, vintage photographs. Gothic architectural elements - arched doorways, baroque frames, ornate columns, aged velvet curtains with moths. LIGHTING: Surreal painterly setup creating Del Toro magic - key light with unusual supernatural color (sickly green #90EE90, deep purple #4B0082, or eerie cyan #00FFCC) creating otherworldly glow on THEIR FACE, multiple colored rim lights from impossible angles (purple from below, gold from side, green from above) creating separation and mystery, practical warm candlelight creating contrast and intimate pools of amber, atmospheric haze catching ALL colored light beams creating magical realism and volumetric effects. Light appearing from impossible sources - glowing flowers, luminescent mist, supernatural aura. Subtle lens effects - soft glow, dreamy halation on highlights. CINEMATOGRAPHY: Slightly Dutch angle (5-10 degrees) creating subtle unease, f/1.8 super shallow DoF with creamy bokeh, THEIR FACE in razor-sharp focus while background dissolves into painterly soft focus with floating elements, subtle lens distortion creating dreamlike quality, fine film grain and subtle chromatic aberration on edges. Del Toro palette - deep teals (#008B8B), burgundy (#800020), poisonous greens (#9ACD32), old gold (#CFB53B), midnight blues (#191970), ash grays. Pan's Labyrinth meets Crimson Peak meets Sleepy Hollow aesthetic - hauntingly beautiful, gothic romance, unsettling elegance, dark fairytale. Fine art photography meets dark fantasy cinema. The beautiful nightmare that mesmerizes.${commonEnding}`;
