            ...
            <div className="avatar-container">
              {isLoading ? (
                <div className="loading-indicator" style={{textAlign: "center", padding: "40px 0"}}>
                  ...
                  <br />
                  <div className="spinner" style={{margin: "20px auto", width: 40, height: 40, border: "4px solid #ccc", borderTop: "4px solid #1B2FE7", borderRadius: "50%", animation: "spin 1s linear infinite"}} />
                </div>
              ) : (
                <img
